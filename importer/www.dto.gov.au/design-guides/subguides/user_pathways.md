...
-   develop a common understanding with stakeholders of the current [user experience](../../node/481.html) and interaction points before designing the future solution
-   manage and map the change between current and future [user experience](../../node/481.html) from people, process and technology perspectives
-   uncover issues early in the [design process](../../node/971.html).
...
Gather stakeholders in a [workshop](../../node/826.html)to test the initial current state pathway. Be prepared to make amendments to the pathway right up to the end of the workshop.
...
After confirming the current state pathway is an accurate representation of the [user experience](../../node/481.html) as it exist, refocus your stakeholders onto the future user experience. Step through the pathway and identify where changes need to be made.
