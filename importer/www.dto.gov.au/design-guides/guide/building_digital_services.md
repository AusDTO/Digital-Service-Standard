...
-   [Identify existing experience and capability](../../node/571.html#identify)
-   [Reuse, buy, build (in that order)](../../node/571.html#reuse)
-   [Understand service obligations](../../node/571.html#understand)
-   [Use an iterative and user-centred methodology](../../node/571.html#use)
-   [Use open standards](../../node/571.html#useopen)
-   [Select the right tools](../../node/571.html#select)
...
The Digital Transformation Office is coordinating the development of many [core platforms](../../node/886.html) for government. These core platforms should be used before building your own similar software solution.
...
Open standards enable you to leverage defined protocols, approaches and data or information interchange. There is more information available in the [using open standards](../../node/471.html) guide.
