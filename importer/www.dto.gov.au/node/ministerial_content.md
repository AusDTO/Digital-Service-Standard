...
-   comply with [additional requirements during caretaker period](1011.html).
...
The main method of indicating distinction between agency and ministerial websites is through [branding](551.html). For example, the appearance of agency media releases and speeches should be clearly distinct from the appearance of ministerial media releases and speeches.
...
In nearly all cases, ministerial websites will be located in the [gov.au domain-name space](441.html). There is a strong preference for agency-sponsored websites to have a gov.au domain name, but even where a minister prefers an alternative domain name, these guidelines still apply.
