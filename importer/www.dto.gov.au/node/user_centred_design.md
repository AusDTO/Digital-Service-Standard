...
Keep the user at the centre of the [design process](971.html): they are the subject matter experts on what’s easy to use and what isn’t. This means:
...
Be transparent throughout the [design process](971.html) by designing with users; continually testing and building concepts, ideas and prototypes from paper prototypes through to working code. We should accept when we have made a mistake (we’re only human) and re-iterate and test again so the service can be the best it can be for our users.

### Conduct user research

Conduct [user research](481.html) at the beginning and throughout the process to discover user needs, perspectives, natural systems, processes, motivations, attitudes, values and expectations to create a positive user experience.
