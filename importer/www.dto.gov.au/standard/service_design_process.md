...
1.  [Discover and Define](../node/971.html#discoverdefine)
2.  [Create and Iterate](../node/971.html#createiterate)
3.  [Deliver, Evaluate and Improve](../node/971.html#deliverevaluateimprove).

You can move between the phases at any time. Services that can no longer be improved should be considered for [retirement](../node/971.html#retire).

The phases are supported by [design principles](../node/866.html) to ensure good design outcomes are achieved.
...
Identify your users and get to know them. Analyse existing or undertake new [user research](../node/481.html) to: 
...
-   understand what proportion of your users will need [assisted digital support](../node/361.html).
...
Run a series of [workshops](../node/826.html) with the team. Start with an ABCD approach to drive a conversation and develop supporting documentation.
...
-   ABCD modelling
-   [Personas](../node/811.html) and [scenarios](../node/831.html)
-   [User pathways](../node/821.html)
-   [Wireframes](../node/936.html)
-   [Prototypes](../node/841.html)
-   Sketches / whiteboard diagrams
-   [KPI assessment](../node/881.html)
...
-   Concentrate on delivering services which make the [user journey](../node/821.html) and experience as simple, clear and as fast as possible while maintaining integrity of the service

#### *Develop options*

Develop options by using [user research](../node/481.html) and involving a wide range of stakeholders from the private, industry and other parts of the public sector. Run a series of workshops with these stakeholders to develop your options.
...
Create and share the emerging design and thinking as early as possible. Be willing to share your draft [wireframes](../node/936.html) or [prototypes](../node/841.html) with increasing detail and functionality (for example, low and high fidelity prototypes). Keep in mind people are less likely to provide feedback on something that looks finished. Early engagement and consultation will help you to:
...
-   [Workshops](../node/826.html)
-   [User pathways](../node/821.html)
-   [High level design / blueprints](../node/836.html)
...
Check the service meets the Australian Government requirements on [accessibility](../node/456.html), [branding](../node/551.html) and [common website elements](../node/521.html).

Ensure your analytics are configured accurately to monitor the [key performance indicators](../node/881.html) identified in building your service.
