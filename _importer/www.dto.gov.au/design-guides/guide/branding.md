...
-   [Download the correct template](../../node/foi_act_and_information_publication_scheme.md#download)
-   [Present the Design correctly](../../node/foi_act_and_information_publication_scheme.md#presentdesign)
-   [Refer correctly to the Australian Government in content](../../node/foi_act_and_information_publication_scheme.md#refercorrectly)
-   [Check guidance on common uses](../../node/foi_act_and_information_publication_scheme.md#checkguidance)
...
[Australian Government Design](../../node/foi_act_and_information_publication_scheme.md#ausgovdesign) (inline)
...
[Australian Government Design](../../node/foi_act_and_information_publication_scheme.md#ausgovdesign) (stacked)
...
[Agency Design](../../node/foi_act_and_information_publication_scheme.md#ausgovdesign) (inline)
...
[Agency Design](../../node/foi_act_and_information_publication_scheme.md#ausgovdesign) (stacked)
...
[Multiple agencies design](../../node/foi_act_and_information_publication_scheme.md#multipleagencies) (inline)
...
[Multiple agencies design](../../node/foi_act_and_information_publication_scheme.md#multipleagencies) (stacked)
...
[An Australian Government Initiative Design](../../node/foi_act_and_information_publication_scheme.md#austgovinitative) (inline)
...
[An Australian Government Initiative Design](../../node/foi_act_and_information_publication_scheme.md#austgovinitative) (stacked)
...
[Agency functions, divisions and branches](../../node/foi_act_and_information_publication_scheme.md#agencyfunctions) – hierarchy design (inline; stacked is also permitted)
...
[Agency functions, divisions and branches](../../node/foi_act_and_information_publication_scheme.md#agencyfunctions)– functions with distinct branding (inline; stacked is also permitted)
...
[Agency Design co-branding](../../node/foi_act_and_information_publication_scheme.md#cobrand) (inline; the co-brand must appear to the right of the stacked or inline Australian Government Design)
...
The Design can be configured as inline (horizontal) and stacked (with the Coat of Arms sitting above the centralised text) as illustrated in the [template table](../../node/foi_act_and_information_publication_scheme.md#download).
...
Further guidance on [positioning the Design in specific contexts](../../node/foi_act_and_information_publication_scheme.md#checkguidance) is available at the end of this section.
...
Alt text is an [accessibility feature](../../node/foi_act_and_information_publication_scheme.md) used to supply contextual information as an alternative to images. The alt text for the Design (when used only as an image) should read as follows.
...
There is more guidance on [preferred terminology](../../node/foi_act_and_information_publication_scheme.md#usepreferred) available.
