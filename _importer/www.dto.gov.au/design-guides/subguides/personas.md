...
Once each persona is developed, consider developing [scenarios](../../node/foi_act_and_information_publication_scheme.md) then performing a walkthrough to influence your stakeholders to create better services. It’s important to note that personas are not a substitute for user testing.
