---
title: digital_transformation_plan
permalink: digital_transformation_plan.html
layout: default
---
...
The Digital Transformation Office (DTO) is supporting agencies in planning their transformation to provide users with a better experience when dealing with government. The DTO has established a network of [Digital Transformation Coordinators](../node/foi_act_and_information_publication_scheme.md) (DTCs) that supports each agency in the development of a Digital Transformation Plan and progress of services through digital transformation.

Digital Transformation Plan
---------------------------

All non-corporate Commonwealth agencies (most former *Financial Management Accountability Act 1997* agencies) with high volume transaction services (that is, 50,000 transactions per annum) [in scope of the Standard](../node/foi_act_and_information_publication_scheme.md) are required to develop and publish a Digital Transformation Plan.

The Digital Transformation Plan enables agencies to be transparent about their planned transformation activities and report on their progress against the [Digital Transformation Agenda](../node/foi_act_and_information_publication_scheme.md). 
...
-   **How we will get there**
    ...
    -   identification, prioritisation and planning the transformation of high volume transactional services to comply with the [Digital Service Standard](foi_act_and_information_publication_scheme.md)
...
-   Compliance and processes; for example, processes to check the service aligns with [Digital Service Standard](foi_act_and_information_publication_scheme.md)
...
-   catering for the needs of people who require [assisted digital](../node/foi_act_and_information_publication_scheme.md) support
-   plans to integrate non-digital services with digital ones.

### Transformation implementation

Agencies need to use an integrated approach, based on user needs, to build internal capability as well as services. Agencies should translate user needs into services that are simple and intuitive enough so that users succeed digitally, first time, every time. The [digital service design principles](../node/foi_act_and_information_publication_scheme.md) should underpin agency implementation.
...
-   Does the service comply with the [Digital Service Standard](foi_act_and_information_publication_scheme.md)?
