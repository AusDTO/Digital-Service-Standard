...
Offline interactions are also a key part of providing [assisted digital](foi_act_and_information_publication_scheme.md) support to users moving to digital interaction with government.
...
-   identify where people struggle across all channels when interacting with government, and design digital services that overcome these issues using whole-of-government [analytics](foi_act_and_information_publication_scheme.md) and [user research](foi_act_and_information_publication_scheme.md)
