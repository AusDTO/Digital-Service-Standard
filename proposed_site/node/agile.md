...
Agile development is about iterating quickly to deliver value to your users. In contrast to traditional development methodologies like [waterfall](https://en.wikipedia.org/wiki/Waterfall_model), agile development requires [continuous delivery](foi_act_and_information_publication_scheme.md#continuousdelivery), improvement and feedback from users. The benefit is that teams can quickly adapt and align services with [user needs](foi_act_and_information_publication_scheme.md#userstories) in rapidly changing environments.
...
-   [User stories](foi_act_and_information_publication_scheme.md#userstories)
-   [Roadmap](foi_act_and_information_publication_scheme.md#roadmap)
-   [Agile teams](foi_act_and_information_publication_scheme.md#agileteams)
-   [Sprints](foi_act_and_information_publication_scheme.md#sprints)
-   [Backlog](foi_act_and_information_publication_scheme.md#backlog)
-   [Continuous delivery](foi_act_and_information_publication_scheme.md#continuousdelivery)
-   [Agile meetings](foi_act_and_information_publication_scheme.md#agilemeetings)

### User stories

User stories are a way to understand and capture your user needs. They are a fundamental [user research tool](foi_act_and_information_publication_scheme.md) for identifying stakeholders and context.
...
Once you have a collection of user stories that fit into the services’ overall objective you can use them to prioritise the team’s work into [sprints](foi_act_and_information_publication_scheme.md#sprints).
...
The process usually starts with a [sprint planning](foi_act_and_information_publication_scheme.md#sprintplanning) event, in order to:
...
-   prepare the product [backlog](foi_act_and_information_publication_scheme.md#backlog) (the workload) for the first sprint.

### Backlog

Each [sprint](foi_act_and_information_publication_scheme.md#sprints) or unit of work draws on a backlog of prioritised user stories. A well maintained backlog supports an iterative development cycle by enabling the team to track progress at regular intervals, reflecting on what’s been learned and adjusting for future sprints.

#### Prioritising

Create a list of all the work items arising from [user stories](foi_act_and_information_publication_scheme.md) that need to be done to achieve the [roadmap](foi_act_and_information_publication_scheme.md#roadmap) vision. This includes features, bugs, design tasks, technical tasks, administration tasks and research activities, but should be organised into simple user stories as much as possible.
...
Anything that isn’t feasible for the team to work on should be kept in a separate place, where it can be returned to at the next [sprint planning](foi_act_and_information_publication_scheme.md#sprintplanning) session. Some agile approaches refer to this list as the ‘icebox’.
...
The team should meet before and after each sprint. Prior to the [sprint](foi_act_and_information_publication_scheme.md#sprints), the team prioritises the [user stories](foi_act_and_information_publication_scheme.md#userstories) in scope, the tasks required to complete them, and their acceptance criteria. After the sprint, the team members should confirm the completed work against the acceptance criteria. You can include stakeholders in this meeting to explain which user stories have and have not been completed and why.
