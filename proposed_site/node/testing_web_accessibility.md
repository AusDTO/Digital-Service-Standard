...
-   [Stocktake services](foi_act_and_information_publication_scheme.md#stocktake)
-   [Assess capability](foi_act_and_information_publication_scheme.md#assess)
-   [Agree audit methodology](foi_act_and_information_publication_scheme.md#agree)
-   [Prepare report](foi_act_and_information_publication_scheme.md#prepare)
...
You should also use [analytics tools](foi_act_and_information_publication_scheme.md) to understand web traffic; particularly page visits, user demographics, and viewing platforms.
